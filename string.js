...
list[2].innerHTML += `The number of character is ${str.length}`

list[3].innerHTML += str[0]

list[4].innerHTML += str[str.length - 1]

list[5].innerText += `Dog is located at index ${str.indexOf('dog', 41)}`
list[6].innerText += `Goat is located at index ${str.indexOf('goat')}`
list[7].innerText += `The last index of 'the' is ${str.indexOf('the')}`
...
list[12].innerHTML += `remove all spaces: <strong>${str.split(" ").join(' - ')}</strong>`